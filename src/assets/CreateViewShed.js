...
import * as kriging from "./kriging2";
...
ViewShedAnalysis.prototype = {
    ...
    setLightCamera: function () {
        ...
        this.lightCamera.frustum.near = 0.1;//近平面的距离。
        this.lightCamera.frustum.far = visualRange;//远平面的距离
        ...
        this.lightCamera.frustum.aspectRatio =
            ...
            (visualRange * Math.tan(vr / 2) * 2);//视锥的宽度与高度的纵横比。
        this.lightCamera.frustum.fov = hr > vr ? hr : vr;//视场角（FOV），以弧度为单位。
