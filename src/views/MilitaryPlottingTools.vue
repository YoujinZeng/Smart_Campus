...
<script>
import MilitaryPlotting from '../assets/MilitaryPlotting';
      ...
      items: [
        {
          ...
          image:  new URL('../assets/images/free-line.png', import.meta.url).href,
          type: "FreeLine",
        },
        {
          name: "折线",
          image: new URL('../assets/images/polyline.png', import.meta.url).href,
          type: "Polyline",
        },
        // {
        //   name: "曲线",
        //   image:new URL('../assets/images/curve.png', import.meta.url).href,
        //   type: "Curve",
        // },
        // {
        //   name: "自由面",
        //   image:new URL('../assets/images/staging-area.png', import.meta.url).href,
        //   type: "FreePolygon",
        // },
        // {
        //   name: "多边形",
        //   image: new URL('../assets/images/easy.png', import.meta.url).href,
        //   type: "Polygon",
        // },
        // {
        //   name: "正多边形",
        //   image:new URL('../assets/images/polygon.png', import.meta.url).href,
        //   type: "RegularPolygon",
        // },
        // {
        //   name: "简单直线箭头",
        //   image:new URL('../assets/images/straight-line-arrow.png', import.meta.url).href,
        //   type: "StraightLineArrow",
        // },
        // {
        //   name: "简单曲线箭头",
        //   image:new URL('../assets/images/curve-line-arrow.png', import.meta.url).href,
        //   type: "CurveLineArrow",
        // },
        {
          name: "直角箭头",
          image:new URL('../assets/images/right-angle-arrow.png', import.meta.url).href,
          type: "RightAngleArrow",
        },
        {
          name: "燕尾箭头",
          image:new URL('../assets/images/swallowtail-arrow.png', import.meta.url).href,
          type: "SwallowtailArrow",
        },
        {
          name: "钳击箭头",
          image: new URL('../assets/images/pincer-arrow.png', import.meta.url).href,
          type: "PincerArrow",
        },
        {
          name: "进攻箭头",
          image: new URL('../assets/images/attack-arrow.png', import.meta.url).href,
          type: "AttackArrow",
        },
        {
          name: "圆角矩形",
          image: new URL('../assets/images/round-rectangle.png', import.meta.url).href,
          type: "RoundRectangle",
        },
        {
          name: "扇形",
          image: new URL('../assets/images/sector.png', import.meta.url).href,
          type: "Sector",
        },
        {
          name: "弓形",
          image: new URL('../assets/images/bow.png', import.meta.url).href,
          type: "Bow",
        },
        {
          name: "集结地",
        ...
        {
          name: "清空",
          image:  new URL('../assets/images/delete.png', import.meta.url).href,
          type: "RemoveAll",
        },
      ],
    };
